...
public class VcfMeta {
  ...
  public Iterable<VcfMetaContig> getContigMeta() {
    return vcfMetaContigs != null
        ? vcfMetaContigs.values()
        : Collections.<VcfMetaContig>emptyList();
  }
  ...
  public Iterable<VcfMetaFilter> getFilterMeta() {
    return vcfMetaFilters != null
        ? vcfMetaFilters.values()
        : Collections.<VcfMetaFilter>emptyList();
  }
  ...
  public Iterable<VcfMetaFormat> getFormatMeta() {
    return vcfMetaFormats != null
        ? vcfMetaFormats.values()
        : Collections.<VcfMetaFormat>emptyList();
  }
  ...
  public Iterable<VcfMetaSample> getSampleMeta() {
    return vcfMetaSamples != null
        ? vcfMetaSamples.values()
        : Collections.<VcfMetaSample>emptyList();
  }
  ...
  public String toString() {
    ...
    if (vcfMetaAlts != null) {
      for (VcfMetaAlt vcfMetaAlt : vcfMetaAlts.values()) strBuilder.append(vcfMetaAlt);
    }
    if (vcfMetaContigs != null) {
      for (VcfMetaContig vcfMetaContig : vcfMetaContigs.values()) strBuilder.append(vcfMetaContig);
    }
    if (vcfMetaFilters != null) {
      for (VcfMetaFilter vcfMetaFilter : vcfMetaFilters.values()) strBuilder.append(vcfMetaFilter);
    }
    if (vcfMetaFormats != null) {
      for (VcfMetaFormat vcfMetaFormat : vcfMetaFormats.values()) strBuilder.append(vcfMetaFormat);
    }
    if (vcfMetaInfos != null) {
      for (VcfMetaInfo vcfMetaInfo : vcfMetaInfos.values()) strBuilder.append(vcfMetaInfo);
    }
    if (vcfMetaSamples != null) {
      for (VcfMetaSample vcfMetaSample : vcfMetaSamples.values()) strBuilder.append(vcfMetaSample);
    }
    if (vcfMetaPedigrees != null) {
      for (VcfMetaPedigree vcfMetaPedigree : vcfMetaPedigrees) strBuilder.append(vcfMetaPedigree);
    }
