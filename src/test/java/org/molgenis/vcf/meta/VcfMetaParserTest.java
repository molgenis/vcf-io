...
public class VcfMetaParserTest {
  ...
  public void parse() throws IOException {
    ...
    assertEquals(vcfMeta.get("mycustomheader"), "mycustomvalue");
    assertEquals(
        Lists.newArrayList(vcfMeta.getContigMeta()), Arrays.asList(vcfMetaContig1, vcfMetaContig2));
    ...
    assertEquals(
        vcfMeta.getColNames(),
        new String[] {"#CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO"});
  }
}
